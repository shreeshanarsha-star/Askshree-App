...
const TOPICS = [
  ...
  { label: 'Artificial Intelligence', href: "/writings/artificial-intelligence", active: true },
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ padding: '56px 24px 80px', maxWidth: 760, margin: '0 auto' }}>
        ...
        <h1 style={{ fontFamily: 'Fraunces, serif', fontWeight: 500, fontSize: 32, color: 'var(--cream)', margin: '0 0 40px' }}>Artificial Intelligence</h1>

        <div style={{ border: '1px solid var(--line)', borderRadius: 10, padding: 32, background: 'rgba(255,255,255,0.015)' }}>
          <p style={{ fontFamily: 'Fraunces, serif', fontSize: 16, color: 'var(--cream)', margin: '0 0 8px' }}>First piece on Artificial Intelligence &mdash; coming soon</p>
...
export default function ArtificialIntelligenceContentWrapper() {
  ...
  return <ArtificialIntelligenceContent />;
}
