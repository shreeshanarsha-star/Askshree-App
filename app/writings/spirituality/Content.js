...
const TOPICS = [
  ...
  { label: 'Spirituality', href: "/writings/spirituality", active: true },
];

function SpiritualityContent() {
  return (
    <ThemeShell>
      <div className="nav">
      ...
      <div style={{ padding: '56px 24px 80px', maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ border: '1px solid var(--line)', borderRadius: 10, padding: 32, background: 'rgba(255,255,255,0.015)' }}>
          <p style={{ fontFamily: 'Fraunces, serif', fontSize: 16, color: 'var(--cream)', margin: '0 0 8px' }}>First piece on Spirituality &mdash; coming soon</p>
...
export default function SpiritualityContentWrapper() {
