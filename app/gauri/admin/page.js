            ...
            <tbody>
              {accounts.map((a) => (
                <tr key={a.id}>
                  ...
                  <td>{a.username}</td>
                  <td>{a.role}</td>
                  <td><span className="status-pill" style={a.active ? { background: 'rgba(120,200,140,0.15)', color: '#7bd08f' } : { background: 'rgba(220,80,80,0.15)', color: '#e28080' }}>{a.active ? 'Active' : 'Deactivated'}</span></td>
