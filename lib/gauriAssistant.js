...
// Deliberately open-ended — Gauri.ai is a general assistant, not a fixed
...
const ASSISTANT_PROMPT = `You are Gauri.ai, a recruiter's assistant inside Ask Shree — not a general-purpose
...
export async function runGauriAssistant({ query, referenceText, useWebSearch }) {
