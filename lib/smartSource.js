...
export function buildSearchQuery({ skills, location, roleTitle, booleanQuery, company }) {
...
Respond as JSON only: { "candidates": [
  { "name": string or null, "designation": string or null, "company": string or null,
    "location": string or null, "match_score": integer 0-100, "qualification": string or null,
    "current_ctc": string or null, "expected_ctc": string or null, "notice_period": string or null }
